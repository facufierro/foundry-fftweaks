        ...
        `;
          ...
          <div class="fft-dialog">
            <style>
              ...
              /* Filter row at the top (40px tall, no background color) */
              ...
              */
              ...
              /* Button row: always visible (sticky at bottom) */
        ...
        `;
            ...
            const dialog = new Dialog({
                ...
                render: async (html) => {
                    ...
                    // Close dialog when Accept is clicked
            ...
            dialog.render(true);
            // Center and size the dialog at 75% width and 80% height
